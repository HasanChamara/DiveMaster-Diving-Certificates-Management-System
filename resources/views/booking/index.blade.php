         ...
         <div class="trp-right-col-top">
            ...
            <div class="trp-section trp-cus-mgmnt trp-table-container">
                  ...
                  <tbody>
                     @foreach($bookings as $booking)
                        <tr>
                           ...
                           <td>
                              <form action="{{ route('bookings.update', $booking->id) }}" method="POST" class="booking-form" data-booking-id="{{ $booking->id }}">
                                 @csrf
                                 <select name="status" required class="status-select" onchange="checkStatus({{ $booking->id }}, this)">
               ...
               <nav class="trp-table-pagination-container">
                  <ul class="pagination d-flex align-items-center justify-content-between m-0" id="paginationBookings">
                     <div class="trp-prev-arrow">
                        <li class="page-item"><a class="page-link trp-previous" href="#" id="trBookings_prev">Previous</a></li>
                     </div>
                     <div class="trp-page-numbers trBookings d-flex"></div>
                     <div class="trp-next-arrow">
                        <li class="page-item"><a class="page-link trp-next" href="#" id="trBookings_next">Next</a></li>
                     </div>
                  </ul>
               </nav>
            </div>
